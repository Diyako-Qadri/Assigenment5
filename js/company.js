$(() => {
  function Student(name, lastname, title, location, fulltime, about, experience, portfolio) {
    (this.name = name), (this.lastname = lastname), (this.title = title), (this.location = location), (this.fulltime = fulltime), (this.about = about), (this.experience = experience), (this.portfolio = portfolio);
  }
  ...
  let Sofia = new Student(
    ...
    "http://www.myawesomeportfolio1.com"
  );
  ...
  let Hicke = new Student(
    ...
    "During this internship I was given more responsibility in projects which involved direct communication with clients, working together in a team with people in different roles and coding challenging designs",
    "http://www.myawesomeportfolio2.com"
  );
  ...
  let Santuzza = new Student(
    ...
    "http://www.myawesomeportfolio3.com"
  );
  let Adriano = new Student(
    ...
    "http://www.myawesomeportfolio4.com"
  );
  let Giacinta = new Student(
    ...
    "http://www.myawesomeportfolio5.com"
  );
  let Romaine = new Student(
    ...
    "http://www.myawesomeportfolio6.com"
  );
  let Sigurd = new Student(
    ...
    "http://www.myawesomeportfolio7.com"
  );
  let Astrid = new Student(
    ...
    "http://www.myawesomeportfolio8.com"
  );
  let Dimitri = new Student(
    ...
    "http://www.myawesomeportfolio9.com"
  );

  let arrayStudentObject = [Sofia, Hicke, Domnick, Santuzza, Adriano, Giacinta, Romaine, Sigurd, Astrid, Dimitri];
